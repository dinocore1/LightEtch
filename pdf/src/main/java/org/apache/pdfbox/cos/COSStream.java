...
public class COSStream extends COSDictionary
{
     ...
     *
     * @throws java.io.IOException when encoding/decoding causes an exception
     */
...
//            }
     ...
     *
     * @throws java.io.IOException If there is an error applying a filter to the stream.
     */
...
// FIXME: We shouldn't keep the same reference?
     ...
     *
     * @throws java.io.IOException If there is an error parsing the stream.
     */
     ...
     *
     * @throws java.io.IOException If there is an error clearing the old filters.
     */
