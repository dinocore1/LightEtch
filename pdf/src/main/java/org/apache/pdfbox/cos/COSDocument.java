...
public class COSDocument extends COSBase implements Closeable
{
     ...
     *
     *  @throws java.io.IOException If there is an error creating the tmp file.
     */
     ...
     * @throws java.io.IOException If there is an error getting the object
     */
     ...
     * @throws java.io.IOException if no document catalog can be found
     */
     ...
     *
     * @throws java.io.IOException If no catalog can be found.
     */
     ...
     *
     *  @throws java.io.IOException If there is an error close resources.
     */
     ...
     * @throws java.io.IOException if an error occurs while closing the temporary files
     */
    @Override
     ...
     *
     * @throws java.io.IOException If there is an error getting the proxy object.
     */
