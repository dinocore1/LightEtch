...
public class ResourceLoader
{
     ...
     * 
     * @throws java.io.IOException If there is an error while attempting to load the resource.
     */
     ...
     * @return The resource as a stream or null if it could not be found.
     * 
     * @throws java.io.IOException If there is an error loading the properties.
     */
