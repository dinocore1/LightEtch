...
public class AFMParser
{
     ...
     * @param args Ignored.
     *
     * @throws java.io.IOException If there is an error parsing one of the documents.
     */
     ...
     * 
     * @throws java.io.IOException If there is an IO error reading the document.
     */
     ...
     *
     * @throws java.io.IOException If there is an error reading the AFM file.
     */
     ...
     *
     * @throws java.io.IOException If the string is in an invalid format.
     */
     ...
     *
     * @throws java.io.IOException If there is an error parsing the composite.
     */
     ...
     *
     * @throws java.io.IOException If the semicolon is missing.
     */
     ...
     *
     * @throws java.io.IOException If an IO error occurs when reading from the stream.
     */
